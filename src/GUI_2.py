...
# print(feat_df[["particle", "path_length", "disp", "persistence"]].head())
# print(f"Mean persistence: {feat_df['persistence'].mean():.3f}")
# mean_persistence = feat_df['particle'].mean()
mean_speed = feat_df["speed"].mean()
mean_disp = feat_df["disp"].mean()
# mean_particle = feat_df["particle"].mean()
